...
public class EmailVerificationController {
  ...
  public Mono<ResponseEntity<HttpApiResponse<VerificationCodeCreateResponse>>> sendEmailVerificationCode(
    ...
    return Mono.just(ResponseEntity.ok(HttpApiResponse.success(
