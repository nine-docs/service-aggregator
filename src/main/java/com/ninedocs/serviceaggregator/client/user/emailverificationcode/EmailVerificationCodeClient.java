...
import com.ninedocs.serviceaggregator.client.user.common.dto.ClientResponse;
...
public class EmailVerificationCodeClient {
  ...
  public Mono<ClientResponse<EmailVerificationCodeResponse>> sendEmailVerificationCode(String email) {
